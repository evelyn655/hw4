...
while(True):
    ...
    for tag in img.find_apriltags(fx=f_x, fy=f_y, cx=c_x, cy=c_y): # defaults to TAG36H11
      ...
      #print_args = (tag.x_translation(), tag.y_translation(), tag.z_translation(), \
             #degrees(tag.rotation()), degrees( tag.x_rotation()), degrees(tag.y_rotation()), degrees(tag.z_rotation()))
      ## Translation units are unknown. Rotation units are in degrees.
      #uart.write(("Tx: %f, Ty %f, Tz %f, rotation %f, Rx %f, Ry %f, Rz %f" % print_args).encode())
      #print("Tx: %f, Ty %f, Tz %f, rotation %f, Rx %f, Ry %f, Rz %f" % print_args)
#uart.write(("FPS %f\r\n" % clock.fps()).encode())
